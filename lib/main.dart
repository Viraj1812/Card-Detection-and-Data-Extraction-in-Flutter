...
import 'package:_edge/eid_scanner.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getImageFromCamera() async {
    ...
    data = await EIDScanner.scanEmirateId(image: File(imagePath));
  ...
  //     data = await EIDScanner.scanEmirateId(image: File(_imagePath!));
  //     if (data != null) {
  //       setState(() {});
  //       print(data.toString());
  //     }
